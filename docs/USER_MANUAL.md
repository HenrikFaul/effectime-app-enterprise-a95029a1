...
### Kérelem létrehozása más nevében (Admin Override)

Ez a művelet új szabadságkérelmet hoz létre egy aktív munkaterületi tag nevében;
nem írja át egy már létező kérelem döntését. A vezérlő csak a megfelelő csomag és
`admin_override` szerkesztési jogosultság betöltése után jelenik meg.

1. Nyissa meg a **Kérelmek → Jóváhagyások** részt, majd az admin-kérelem dialógust.
2. Válassza ki a tagot, a szabadságtípust és az időszakot. Félnapos kérésnél a
   kezdőnap az egyetlen érintett nap; teljes napnál végdátum is kötelező.
3. Futtassa az ütközésellenőrzést. Technikai hiba esetén a létrehozás blokkolt,
   és az **Ellenőrzés** gomb újbóli megnyomásával ismételhető.
4. Adja meg a kötelező adminisztratív indoklást. A sikeresen kiértékelt üzleti
   ütközés külön, látható figyelmeztetés mellett felülbírálható.
5. Bekapcsolt automatikus jóváhagyással az új kérelem jóváhagyott, kikapcsolva
   függő státuszban jön létre. Siker után a jóváhagyási és kérelemlista frissül.
