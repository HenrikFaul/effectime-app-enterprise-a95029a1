...
- **RÉSZBEN BIZONYÍTOTT / NO-GO:** hosted Xcode 26 feloldotta a SwiftPM gráfot,
  de az első bootstrap futás tervezetten megállt a simulator fordítás előtt.
...
- **BIZONYÍTOTT hosted futásban:** a frontend, Edge, payroll PostgreSQL és
  ...
  szándékosan leállt. A következő candidate csak review-zott, commitolt lockkal,
...
- **RÉSZBEN BIZONYÍTOTT:** a lokális és az első hosted Android
  compile/lint/debug build zöld; **NO-GO**, amíg a végső lockos candidate SHA
  hosted futása, érdemi natív tesztforrás és emulatoros/fizikai smoke hiányzik.
...
| Candidate provenance             | **BIZONYÍTOTT:** a platform/CI csomag és az exact review-zott Swift lock candidate commitokban rögzített; a lokális release gate 363/363 PASS. | Ugyanezen végső candidate hosted Android+iOS compile és release evidence. |
...
| iOS macOS compile                 | **RÉSZBEN BIZONYÍTOTT:** hosted Xcode 26 SPM resolve zöld, a bootstrap futás tervezetten compile előtt állt meg. | Tiszta final-candidate macOS/Xcode `cap sync`, locked simulator build/test és archiválási próba. |
...
| Native CI                         | **RÉSZBEN BIZONYÍTOTT:** az első hosted Android job zöld; az iOS bootstrap Xcode-dal lockot generált és tervezetten megállt. | Mindkét job zöld ugyanazon végső candidate SHA-n; Android debug artifact és GitHub Actions logok megőrizve.                                |
...
- **BIZONYÍTOTT:** a lokális implementáció, a commitolt candidate forrás és a
  ...
  store release **NO-GO** a végső hosted iOS compile és store/device kapuk nélkül.
