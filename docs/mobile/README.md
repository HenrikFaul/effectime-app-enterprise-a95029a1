...
- **BIZONYÍTOTT v3.51.6 source + hosted candidate:** az atomi member-profile read/save
  ...
  coverage 896/896, mobile 183/345/2 és drift 0 PASS. Draft PR #177 commit
  `cce3fcade3c0a191166a57034e31b89832eafbe8` hosted run `29868355151` mind a
  10 jobja PASS, az Android és locked iOS simulator compile-lal együtt;
  release evidence `8510171690`, unsigned Android artifact `8510141514`.
