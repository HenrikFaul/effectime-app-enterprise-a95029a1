...
- **BIZONYÍTOTT v3.51.7 source + hosted candidate:** a pre-Auth identity-provisioning
  ...
  11 javulással. Draft PR #178 source commitja
  `77531b818b95a1cbe54a8d20abc3e3047a0c1c1e`; hosted run `29879329719`
  10/10 PASS, release evidence `8514194752`, diagnostics `8514193053`, unsigned
  Android artifact `8514165397`. Ez source/CI és nem store/production bizonyíték.
- **NO-GO:** a recurring identity-cleanup scheduler nincs telepítve. Restored-
  staging, reviewed scheduler, DB-first rollout és live SHA-attestation nélkül
  a v3.51.7 nem production deploy vagy aláírt store release.
- **BIZONYÍTOTT:** a v3.51.4-en commitolt platformforrás, a v3.51.5–3.51.7
