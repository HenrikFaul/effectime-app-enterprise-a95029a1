...
10. Az exact `csv_import` + `members_list` source-kapu az I-42 candidate-ben,
    ...
    I-43 source + hosted candidate-ben elkészült. A következő kis kockázatú P1
    csomag az Import Wizard feltöltés utáni zsákutcáját, response-validációját,
    eredeti sorindexeit és sanitizált code/request-ID hibakezelését zárja le;
    ezt követi a specifikációban vállalt teljes tranzakciósság, a mutációkori
