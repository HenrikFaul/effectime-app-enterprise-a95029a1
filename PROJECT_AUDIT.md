...
| Release identity / Edge SBOM contract   | I-37 LOKÁLIS + HOSTED PASS | Current release-identity 55/55 és Edge SBOM unit 7/7; a clean implementation HEAD pontos SHA-jára manifest készült. Run `29917203882` merge-candidate manifestje 62 981 byte; web SBOM 707, Edge SBOM 464 komponens / 31 entrypoint. |
...
| `npm run mobile:sync` / release check   | I-37 CLEAN-HEAD PASS | Android/iOS sync és normalizálás exact `cfb1322…` HEAD-en determinisztikus, natív drift 0; a clean release contract 365/365 PASS és a manifest ugyanazt a HEAD-et attesztálja. |
...
| `npm run bundle:check`                  | I-37 LOKÁLIS + HOSTED PASS | Clean HEAD: JS 4 537 804 raw / 1 299 567 gzip; largest 1 767 981 / 562 184; CSS 180 900 / 29 610. Hosted merge candidate: 4 537 786 / 1 299 514; largest 1 767 981 / 562 186; CSS azonos. Az explicit szűk baseline PASS; nincs nyitott plafon. |
