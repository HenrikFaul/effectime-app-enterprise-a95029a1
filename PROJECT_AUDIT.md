...
- Current-tree magas bizonyosságú secret scan 1 556 követett és nem ignorált
  ...
  fetched refekből elérhető Git-előzmény külön scannerrel: az exact `ee032dc…`
  implementációs HEAD-en 882 commitobjektum, 0 annotált tagobjektum, 3 649
  egyedi blob, 1 618 tartalmilag is vizsgált történeti útvonal, 3 602 szöveges
  és 47 bináris blob, összesen 208 331 486
...
| R-047 | Teljes fetched Git-előzmény magas bizonyosságú secret kapuja | korábbi current-tree-only scanner + auditban nyitott history scan | BIZONYÍTOTT source + local contract | közös detector core; current-tree és all-ref blob/commit/tag scanner; külön, tartalmilag vizsgált történeti path inventory; CI a dependency install előtt | igen a candidate-ben | scanner 9/9; current 1 556; exact `ee032dc…` history 882 commitobjektum / 0 tag / 3 649 blob / 208 331 486 byte; source 226/226 | igen | implementáció commitolva; hosted bizonyíték nyitott | push/stacked PR; hosted 11-job gate; production rollout-blokkerek változatlanok |
...
| `npm run mobile:sync` / release check   | I-39 CLEAN-HEAD PASS | Exact `ee032dc…` Android/iOS sync és normalizálás determinisztikus, natív drift 0; release contract 408/408 és a 62 910 byte-os manifest ugyanazt a HEAD-et attesztálja. |
...
| `npm run bundle:check`                  | I-39 LOKÁLIS + I-38 HOSTED PASS | Exact `ee032dc…` I-39: JS 4 537 804 raw / 1 299 464 gzip; largest 1 767 981 / 562 180; CSS 180 900 / 29 610. I-38 hosted merge: 4 537 786 / 1 299 542, largest 1 767 981 / 562 191. A szűk baseline PASS. |
...
| `npm run security:secrets:history`      | I-39 LOKÁLIS PASS       | Exact `ee032dc…`, nem shallow all-ref scan: 882 commitobjektum, 0 annotált tag, 3 649 egyedi blob, 1 618 tartalmilag vizsgált történeti útvonal, 3 602 szöveg + 47 bináris blob és 208 331 486 streamelt objektum-byte; secret/signing találat 0. |
...
A valós, exact `ee032dc…` all-ref leltár 882 commitobjektum / 0 tag / 3 649 blob /
208 331 486 byte, találat nélkül; a CI source contract 226/226. Ez source/CI hardening, nem runtime
