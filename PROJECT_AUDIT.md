...
| Bundle-méret                        | Tiszta, commitolt iCal/override artifact: JS 4 447 914 raw / 1 269 822 gzip byte; legnagyobb chunk 1 738 375 raw / 551 574 gzip; CSS 180 798 raw / 29 589 gzip. A task-lifecycle merge plafonjához képest +1 559 raw / +192 gzip byte (+0,035%) és +468 largest-raw; a reviewed total-gzip plafon 1 269 950 a szűk build-SHA tömörítési toleranciával, largest-gzip és CSS plafon nem nőtt. | M | további route split és regressziós mérés |
...
| `npm run bundle:check`                  | PASS                    | Tiszta commit artifact: JS 4 447 914 raw / 1 269 822 gzip; largest 1 738 375 raw / 551 574 gzip; CSS 180 798 / 29 589. Az iCal/override hardening +1 559 raw / +192 gzip (+0,035%), +468 largest-raw; reviewed total-gzip ceiling 1 269 950, largest-gzip és CSS plafon változatlan. |
