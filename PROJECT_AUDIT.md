...
| Bundle-méret                        | Current I-36 build: JS 4 529 639 raw / 1 297 427 gzip; largest 1 765 336 raw / 561 521 gzip; CSS 180 862 / 29 600. Az explicit reviewed bundle gate zöld, de az abszolút méret továbbra is jelentős. | M | további route split; hosted artifact összevetés; regressziós mérés |
...
| Release identity / Edge SBOM contract   | I-36 LOKÁLIS / I-35 HOSTED PASS | Current release-identity 55/55 és Edge SBOM unit 7/7; a verifier strict clean HEAD-et követel, továbbá determinisztikus web/mobile fingerprintet, immutable Edge source-tree-t és pontos Edge inventoryt. A legutóbbi hosted I-35 release artifact `8524406237`; I-36 hosted bizonyíték még függőben. |
...
| `npm run mobile:sync` / release check   | I-36 LOKÁLIS / I-35 HOSTED PASS | Android/iOS sync és normalizálás current tree-n PASS, natív drift 0; a clean-HEAD 365/365 release assertion I-36 commit után futtatható. A legutóbbi hosted bizonyíték az I-35 `cb0358e…` commit. |
...
| `npm run bundle:check`                  | I-36 LOKÁLIS PASS       | Candidate build: JS 4 529 639 raw / 1 297 427 gzip; largest 1 765 336 raw / 561 521 gzip; CSS 180 862 / 29 600; exact reviewed baseline alatt. |
...
A v3.51.14 I-36 lokális source candidate öt másodperces funkciószintű install
...
183/345/2, Edge 86/86, release/security és provenance kapuk is PASS. A hosted
CI még függőben van. A migration-history drift miatt linked apply és production
deploy továbbra sem engedélyezett.
