...
| Release identity / Edge SBOM contract   | I-34 LOKÁLIS + HOSTED PASS | Release-identity 55/55 és Edge SBOM 7/7; strict full-SHA/clean HEAD, deterministic web/mobile fingerprint, immutable Edge source-tree és pontos Edge inventory. A tiszta `1aa7bcd…` commitból lokális 62 924 byte-os manifest, 707 web- és 464 Edge-komponenses SBOM készült; hosted release artifact `8522068999`. |
...
| `npm run mobile:sync` / release check   | I-34 LOKÁLIS PASS       | Android/iOS sync és normalizálás PASS, natív drift 0; a tiszta `1aa7bcd…` implementation commiton 365/365 fail-closed release assertion PASS. |
...
Az I-34 következő kontrollált hulláma csak history reconcile után a restored-
staging DB-first acceptance. A runtime feature-status/
