...
| Bundle-méret                        | I-22 lokális candidate: JS 4 452 913 raw / 1 271 182 gzip; largest 1 739 506 / 551 842; CSS 180 798 / 29 589. Az I-21 tiszta main artifacthoz képest +4 999 raw / +1 360 gzip (+0,112% raw), largest +1 131 / +268; exact raw plafonok és a korábbi 128-byte total-gzip tolerancia frissült, largest-gzip/CSS plafon nem nőtt. | M | további route split és regressziós mérés |
...
| `npm run bundle:check`                  | PASS                    | I-22 lokális candidate: JS 4 452 913 raw / 1 271 182 gzip; largest 1 739 506 / 551 842; CSS 180 798 / 29 589. Az I-21 artifacthoz képest +4 999 raw / +1 360 gzip (+0,112% raw); reviewed total-gzip ceiling 1 271 310, largest-gzip és CSS plafon változatlan. |
