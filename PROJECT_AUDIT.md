...
install/uninstall számlálórace-t friss statement-snapshotra épülő lock-protokollal
  ...
  0 dependency vulnerability lokálisan PASS. Clean-worktree release és exact-
  head hosted kapu commit után futtatandó. A külön time-attendance payroll export
  továbbra is one-shot RPC-t castol és record előtt indít letöltést; ez a
...
| R-055 | Export Wizard + legacy leave bounded exact-count lapozással és csonkolásdetektálással | szolgáltatói implicit row limit; explicit range/count hiánya; nagy export csendes részhalmaz-kockázata; legacy enrichment és napi artifact-expanzió; XLS worksheet-limit; runtime provider-sor séma | BIZONYÍTOTT local source candidate | közös 500-row exact-count pager; 100 000 source-row cap; expected page length; stabil order + immutable identity (a request-ID nélküli leave RPC-nél teljes projekciós tuple); globális duplicate guard az identity-s forrásokon; multi-page final count; table HEAD és VOLATILE RPC POST probe; 200-user legacy batch; privacy-allowlisted profile projection; own-property scalar/date parser; központi XLS 65 536 total-row budget; legacy bounded active-interval sweep | kliens runtime-ban igen; DB/API/Edge/dependency változatlan | focused 6/175; full 103/1361; type/lint/build/bundle; web 7/7; mobile 228/390/2; Edge 109/109 + 31/31; security/provenance/release PASS; hosted commit után | igen | branch `codex/export-pagination-integrity`; local source candidate; production NO-GO | authenticated isolated 501+ PostgREST contract; mért query plan/latency; server-owned exact authorization/actor, egy snapshot/job és atomi audit receipt; külön payroll P1 |
...
A v3.51.25 I-47 local source candidate az Import/Export Center Export Wizard és
...
7/7, mobile 228/390/2 clean sync mellett, Edge 109/109 + 31/31, dependency/
secret/provenance/release kapuk lokálisan PASS. Exact-head hosted bizonyíték a
commit/push után kötelező. A külön attendance payroll one-shot cast + download-
