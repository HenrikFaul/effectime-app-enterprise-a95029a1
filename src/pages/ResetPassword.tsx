...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      toast.error('Hiba történt a jelszó frissítésekor. Kérjük, próbáld újra.');
    } else {
      ...
      <div className="flex min-h-screen items-center justify-center bg-background p-4">
        <Card className="w-full max-w-md rounded-2xl">
          <CardContent className="p-6 text-center text-muted-foreground">
            Érvénytelen vagy lejárt visszaállítási link. Kérjük, igényelj új jelszó-visszaállítást.
      ...
      >
        <Card className="rounded-2xl shadow-elevated border">
          <CardHeader className="text-center">
            ...
            <CardDescription>Add meg az új jelszavadat az alábbi mezőkben.</CardDescription>
          </CardHeader>
          <CardContent>
